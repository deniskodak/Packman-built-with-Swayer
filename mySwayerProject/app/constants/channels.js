...
export const CONTENT_SCOPE = { scope: ['@components/main/main.component', '@components/game-board/game-board.component' ] }
export const BOARD_SCOPE = { scope: '@components/game-board/game-board.component' }
